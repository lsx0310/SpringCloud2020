...
public enum ResultCode {
    ...
    FTP_PATH_NOT_EXIST(40017,"远程FTP服务器目录不存在"),
    ...
    SVG_IS_INVALID(50006,"该位置上已存在设备/场站"),
    FIRMWARE_NOT_EXISTED(50007,"对应固件版本不存在，请确认上传"),
    FIRMWARE_IS_LASTEST(50008,"当前设备版本已更新，请勿重复更新"),
